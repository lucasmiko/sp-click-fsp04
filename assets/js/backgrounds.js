...
function showPlace() {
    ...
    heroTitle.innerHTML = place.name;
    heroSubtitle.innerHTML = place.description;
...
let placeInterval = setInterval(showPlace(), 5000)
...
links.forEach((linkElement) => {
    ...
    linkElement.addEventListener('click', () => {
        ...
        placeInterval = setInterval(showPlace, 5000)
